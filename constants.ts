...
const generateSkins = (): Skin[] => {
  ...
  skins.push({ id: 'default', name: 'Operador Padrão', type: 'hexagon', color: '#00f3ff', price: 0 });

  // Helpers
  const shapes: Skin['type'][] = ['hexagon', 'triangle', 'square', 'star', 'circle'];
  const prefixes = ['Neon', 'Dark', 'Hyper', 'Void', 'Cyber', 'Quantum', 'Omega', 'Plasma', 'Solar', 'Lunar', 'Mecha', 'Nano', 'Glitch', 'Flux', 'Aero'];
  const suffixes = ['Viper', 'Core', 'Star', 'Shard', 'Ghost', 'Prime', 'Hex', 'Pulse', 'Drifter', 'Nova', 'Blade', 'Matrix', 'Spark', 'Storm', 'Titan'];
...
export const INITIAL_UPGRADES: Upgrade[] = [
  // Ataque Básico
  { id: 'dmg', name: 'Dano', type: 'attack', baseCost: 10, costMultiplier: 1.4, baseValue: 5, valuePerLevel: 2, level: 1, unit: '', description: 'Dano base por acerto' },
  { id: 'atk_spd', name: 'Vel. Ataque', type: 'attack', baseCost: 15, costMultiplier: 1.5, baseValue: 1.0, valuePerLevel: 0.1, level: 1, unit: '/s', description: 'Ataques por segundo' },
  { id: 'range', name: 'Alcance', type: 'attack', baseCost: 20, costMultiplier: 1.3, baseValue: 150, valuePerLevel: 10, level: 1, unit: 'm', description: 'Distância máx. de ataque' },
  ...
  // Defesa
  { id: 'hp', name: 'Vida', type: 'defense', baseCost: 10, costMultiplier: 1.3, baseValue: 100, valuePerLevel: 20, level: 1, unit: '', description: 'Pontos de Vida Máximos' },
  { id: 'max_shield', name: 'Escudo Energia', type: 'defense', baseCost: 150, costMultiplier: 1.5, baseValue: 20, valuePerLevel: 10, level: 0, unit: '', description: 'Proteção regenerativa' },
  { id: 'regen', name: 'Regen.', type: 'defense', baseCost: 50, costMultiplier: 1.4, baseValue: 1, valuePerLevel: 0.5, level: 0, unit: '/s', description: 'Vida restaurada p/ seg.' },
  { id: 'armor', name: 'Armadura', type: 'defense', baseCost: 75, costMultiplier: 1.5, baseValue: 1, valuePerLevel: 1, level: 0, unit: '', description: 'Redução fixa de dano' },
  { id: 'dodge', name: 'Esquiva', type: 'defense', baseCost: 100, costMultiplier: 1.6, baseValue: 5, valuePerLevel: 0.5, level: 0, unit: '%', description: 'Chance de evitar dano' },

  // Habilidades (Utilities)
  { id: 'emp_dmg', name: 'Dano EMP', type: 'utility', baseCost: 300, costMultiplier: 1.5, baseValue: 50, valuePerLevel: 25, level: 1, unit: '', description: 'Dano da onda de choque' },
  { id: 'emp_cdr', name: 'Recarga EMP', type: 'utility', baseCost: 400, costMultiplier: 1.5, baseValue: 30, valuePerLevel: -2, level: 1, unit: 's', description: 'Tempo de espera do EMP' },
];
